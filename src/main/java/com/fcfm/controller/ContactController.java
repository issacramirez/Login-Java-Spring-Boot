...
import com.fcfm.constant.ViewConstant;
...
@Controller
// @PreAuthorize("permitAll()") ejemplo de securizacion
...
public class ContactController {
    ...
    // @PreAuthorize("hasRole('ROLE_USER') or hasRole('ROLE_ADMIN')") otro ejemplo valido
